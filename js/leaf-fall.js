...
plow.src='img/trompo.gif';
var leafy=new Array();
var leaf_image=new Array();
leaf_image[0]='img/leaf-1.png';
leaf_image[1]='img/leaf-2.png';
leaf_image[2]='img/flor.png';
leaf_image[3]='img/leaf-3.png';
...
function start_fall(i, whyp) {
  var size=65-Math.floor(100*Math.random());
  dx[i]=Math.random();
  am[i]=8+Math.random()*15;
  dy[i]=1+Math.random()*5;
